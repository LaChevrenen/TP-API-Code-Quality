...
export function createUserRouter(repo?: InMemoryUserRepo) {
  const userRepo = repo || new InMemoryUserRepo();
  ...
  router.put('/:id', async (req, res) => {
    ...
    const updated = await service.updateUser(id, { email, password, coordinate_id, party_id });
